      ...
      <div className="mx-auto max-w-7xl px-4 py-24 md:px-8 md:py-36">
        <div className="mb-12 md:mb-16">
          <Rv className="flex items-center gap-4 mb-5">
            ...
            <span className="font-mono text-dim text-xs tracking-[0.3em] uppercase">rendered output</span>
          </Rv>
          <div className="flex flex-wrap items-end justify-between gap-6">
            <h2 className="font-display text-3xl md:text-5xl lg:text-6xl font-semibold leading-[1.02] tracking-tight">
              <RvLine>Logits we already</RvLine>
              <RvLine delay={120}><span className="text-copper2">collapsed into results.</span></RvLine>
            </h2>
            <Rv delay={200} className="font-mono text-xs text-dim">3 of 128 shipped passes ↓</Rv>
          </div>
        </div>
